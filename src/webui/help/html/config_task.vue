...
<p>Каждое задание должно иметь свою секцию. Название секции должно совпадать со значением объявленное в <router-link class="reference internal" href="/config/config_schedule" to="/config/config_schedule"><span class="doc">Schedule</span></router-link>.</p>
<div class="admonition attention">
<p class="admonition-title">Внимание</p>
<p>Все нижеописанные параметры относятся к сборщику <strong>lootnika_mysql</strong></p>
</div>
...
<li><p><a class="reference internal" href="#dbhost">DBhost</a></p></li>
<li><p><a class="reference internal" href="#dbport">DBport</a></p></li>
...
<p>Вы можете использовать одновременно несколько разных экспортёров, а так же назначить для каждого задания свой (см. <router-link class="reference internal" href="/config/config_export" to="/config/config_export"><span class="doc">Export</span></router-link>.). Это необязательный параметр и в случае его отсутствия Лутника будет использовать секцию <code class="xref std std-option docutils literal notranslate"><span class="pre">[export]</span></code></p>
...
<div class="section" id="overwritetaskstore">
...
<div class="section" id="dbhost">
<h2>DBhost<a class="headerlink" href="#dbhost" title="Ссылка на этот заголовок">¶</a></h2>
<p>Адрес сервера БД MySQL.</p>
<div class="highlight-cfg notranslate"><div class="highlight"><pre><span></span><span class="na">dbHost</span><span class="o">=</span><span class="s">192.291.11.22</span>
<span class="na">dbHost</span><span class="o">=</span><span class="s">RepoServer</span>
</pre></div>
</div>
</div>
<div class="section" id="dbport">
<h2>DBport<a class="headerlink" href="#dbport" title="Ссылка на этот заголовок">¶</a></h2>
<p>Порт БД источника.</p>
...
<div class="section" id="dbscheme">
<h2>DBscheme<a class="headerlink" href="#dbscheme" title="Ссылка на этот заголовок">¶</a></h2>
<p>Название схемы таблиц в БД источника.</p>
<div class="highlight-cfg notranslate"><div class="highlight"><pre><span></span><span class="na">dbScheme</span><span class="o">=</span><span class="s">forum</span>
</pre></div>
</div>
</div>
<div class="section" id="dbusr">
<h2>DBusr<a class="headerlink" href="#dbusr" title="Ссылка на этот заголовок">¶</a></h2>
<p>Учётная запись которая будет использоваться для подключения к базе данных источника.</p>
<div class="highlight-cfg notranslate"><div class="highlight"><pre><span></span><span class="na">DBusr</span><span class="o">=</span><span class="s">lootnika</span>
</pre></div>
</div>
</div>
<div class="section" id="dbpsw">
<h2>DBpsw<a class="headerlink" href="#dbpsw" title="Ссылка на этот заголовок">¶</a></h2>
<p>Учётная запись которая будет использоваться для подключения к базе данных источника.</p>
<div class="highlight-cfg notranslate"><div class="highlight"><pre><span></span><span class="na">DBpsw</span><span class="o">=</span><span class="s">strongpswd</span>
</pre></div>
</div>
</div>
...
<div class="section" id="skipemptyrows">
...
<p>Независимо от набора полей документа, вы всегда можете использовать его идентификатор в источнике <span class="target" id="index-0"></span><code class="xref std std-envvar docutils literal notranslate"><span class="pre">loot_id</span></code> (см. <a class="reference external" href="#SelectFields">SelectFields</a>).</p>
</div>
<div class="section" id="selectid">
...
<p>Полученные ID используются в запросах на получение полей документа. Запрос обязательно должен возвращать только один столбец. Полученное значение доступно во всех SQL запросах как <span class="target" id="index-1"></span><code class="xref std std-envvar docutils literal notranslate"><span class="pre">loot_id</span></code></p>
...
<div class="section" id="branchname">
...
<div class="admonition attention">
<p class="admonition-title">Внимание</p>
<p>В запросе <code class="xref std std-option docutils literal notranslate"><span class="pre">SelectBranch0-1</span></code> используется поле <span class="target" id="index-2"></span><code class="xref std std-envvar docutils literal notranslate"><span class="pre">id</span></code>, которое есть и в основных и в вспомогательных полях. <strong>В приоритете подстановки поля из собственной ветви всегда выше основных.</strong></p>
</div>
